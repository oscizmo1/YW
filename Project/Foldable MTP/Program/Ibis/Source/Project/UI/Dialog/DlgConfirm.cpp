...
LRESULT CDlgConfirm::OnGUIUpdateTimer(WPARAM wParam, LPARAM lParam)
{
...
// 표시 언어가 변경되었다.
LRESULT CDlgConfirm::OnChangeLanguage(WPARAM wParam, LPARAM lParam)
{
