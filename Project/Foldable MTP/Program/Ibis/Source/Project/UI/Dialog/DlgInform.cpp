...
IMPLEMENT_DYNAMIC(CDlgInform, CDialog)

CDlgInform::CDlgInform(CWnd* pParent /*=NULL*/)
...
LRESULT CDlgInform::OnGUIUpdateTimer(WPARAM wParam, LPARAM lParam)
{
...
// 표시 언어가 변경되었다.
LRESULT CDlgInform::OnChangeLanguage(WPARAM wParam, LPARAM lParam)
{
