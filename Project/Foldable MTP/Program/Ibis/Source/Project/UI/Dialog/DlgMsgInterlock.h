...
class CDlgMsgInterlock : public CDialog
{
	DECLARE_DYNAMIC(CDlgMsgInterlock)

public:
	CDlgMsgInterlock(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CDlgMsgInterlock();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_DLG_MSG_INTERLOCK };
