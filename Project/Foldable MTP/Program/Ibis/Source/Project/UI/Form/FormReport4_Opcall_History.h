...
// CFormReport4_Opcall_History 폼 뷰입니다.

class CFormReport4_Opcall_History : public CFormView
{
	DECLARE_DYNCREATE(CFormReport4_Opcall_History)

public:
	CFormReport4_Opcall_History();           // 동적 만들기에 사용되는 protected 생성자입니다.
	virtual ~CFormReport4_Opcall_History();

public:
	enum { IDD = IDD_FORM_REPORT_OPCALL_HISTORY };
#ifdef _DEBUG
