...
// CFormReport2_Sub 폼 뷰입니다.

class CFormReport2_Sub : public CFormView
{
	DECLARE_DYNCREATE(CFormReport2_Sub)

public:
	CFormReport2_Sub();           // 동적 만들기에 사용되는 protected 생성자입니다.
	virtual ~CFormReport2_Sub();
