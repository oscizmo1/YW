// FormReport2_Sub.cpp : 구현 파일입니다.
//

#include "stdafx.h"
#include "FormReport2_Sub.h"
...
IMPLEMENT_DYNCREATE(CFormReport2_Sub, CFormView)

CFormReport2_Sub::CFormReport2_Sub()
	: CFormView(CFormReport2_Sub::IDD)
{
...
void CFormReport2_Sub::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CFormReport2_Sub, CFormView)
...
// CFormReport2_Sub 진단입니다.

#ifdef _DEBUG
void CFormReport2_Sub::AssertValid() const
{
	CFormView::AssertValid();
}

#ifndef _WIN32_WCE
void CFormReport2_Sub::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif
...
LRESULT CFormReport2_Sub::OnGUIUpdateTimer(WPARAM wParam, LPARAM lParam)
{
...
// 표시 언어가 변경되었다.
LRESULT CFormReport2_Sub::OnChangeLanguage(WPARAM wParam, LPARAM lParam)
{
...
BOOL CFormReport2_Sub::PreCreateWindow(CREATESTRUCT& cs)
{
...
BEGIN_EVENTSINK_MAP(CFormReport2_Sub, CFormView)
	ON_EVENT(CFormReport2_Sub, IDC_GXLBL_ALARM_DAY, DISPID_CLICK, CFormReport2_Sub::ClickGxlblAlarmDay, VTS_NONE)
	ON_EVENT(CFormReport2_Sub, IDC_GXLBL_ALARM_NIGHT, DISPID_CLICK, CFormReport2_Sub::ClickGxlblAlarmNight, VTS_NONE)	
	ON_EVENT(CFormReport2_Sub, IDC_GXLBL_ALARM_PREV, DISPID_CLICK, CFormReport2_Sub::ClickGxlblAlarmPrev, VTS_NONE)
	ON_EVENT(CFormReport2_Sub, IDC_GXLBL_ALARM_NEXT, DISPID_CLICK, CFormReport2_Sub::ClickGxlblAlarmNext, VTS_NONE)
	ON_EVENT(CFormReport2_Sub, IDC_GXLBL_ALARM_TODAY, DISPID_CLICK, CFormReport2_Sub::ClickGxlblAlarmToday, VTS_NONE)
	ON_EVENT(CFormReport2_Sub, IDC_GXLBL_ALARM_TOTAL, DISPID_CLICK, CFormReport2_Sub::ClickGxlblAlarmTotal, VTS_NONE)
END_EVENTSINK_MAP()

#if 0
void CFormReport2_Sub::SetHideLevelCHECK(BOOL bHide)
{
...
#endif
void CFormReport2_Sub::AlarmUdate( int sel )
{
	...
	CGxButtonEx* pAlarmNight = (CGxButtonEx*)GetDlgItem( IDC_GXLBL_ALARM_NIGHT );	
	...
	while(file.ReadString(strBuf))
	{
		...
		if(sel==eIDX_Shift_Today-1)
		{
			shift=2;
		}
	    else if(time_num >= 7 && time_num<19) //작업조 설정
		{
			shift=0;
		}		
		else
...
void CFormReport2_Sub::ClearData()
{
...
void CFormReport2_Sub::ListUpdate()
{
	CGxStaticEx* pAlarmTotalCount = (CGxStaticEx*)GetDlgItem( IDC_LIST_ALARM_COUNT );
	CGxStaticEx* pAlarmTotalSpan = (CGxStaticEx*)GetDlgItem( IDC_LIST_ALARM_TOTAL_SPAN );
	CGxStaticEx* pAlarmNumber1 = (CGxStaticEx*)GetDlgItem( IDC_LIST_ALARM_1_1 );
...
void CFormReport2_Sub::ClickGxlblAlarmDay()
{
...
void CFormReport2_Sub::ClickGxlblAlarmNight()
{
...
void CFormReport2_Sub::ClickGxlblAlarmPrev()
{
...
void CFormReport2_Sub::ClickGxlblAlarmNext()
{
	CGxStaticEx* pAlarmDate = (CGxStaticEx*)GetDlgItem( IDC_GXLBL_ALARM_DATE );
	ClearData();
	//sel_date++;
...
void CFormReport2_Sub::ClickGxlblAlarmToday()
{
...
void CFormReport2_Sub::ClickGxlblAlarmTotal()
{
...
#if 0
void CFormReport2_Sub::ClickGxbtnHideCheck()
{
	if(m_bHideLevelCHECK)
		SetHideLevelCHECK(FALSE);
	else
