...
void CTeachBank::InitializeTeachParam()
{
	...
	m_Param[TEACH_PARAM::JIG_SHUTTLE_Y1_to_LOAD			] = TEACH_PARAM(_T("JIG_SHUTTLE_Y1_to_LOAD"			), AXIS_JIG_SHUTTLE_Y1			, TEACH_PARAM::JIG_SHUTTLE_Y1_to_LOAD		, 0., 0., ACC_300ms, ACC_300ms);
	m_Param[TEACH_PARAM::JIG_SHUTTLE_Y1_to_INSP			] = TEACH_PARAM(_T("JIG_SHUTTLE_Y1_to_INSP"			), AXIS_JIG_SHUTTLE_Y1			, TEACH_PARAM::JIG_SHUTTLE_Y1_to_INSP		, 0., 0., ACC_300ms, ACC_300ms);
	m_Param[TEACH_PARAM::JIG_SHUTTLE_Y1_to_MANUAL		] = TEACH_PARAM(_T("JIG_SHUTTLE_Y1_to_MANUAL"		), AXIS_JIG_SHUTTLE_Y1			, TEACH_PARAM::JIG_SHUTTLE_Y1_to_MANUAL		, 0., 0., ACC_300ms, ACC_300ms);

	m_Param[TEACH_PARAM::JIG_SHUTTLE_Y2_to_LOAD			] = TEACH_PARAM(_T("JIG_SHUTTLE_Y2_to_LOAD"			), AXIS_JIG_SHUTTLE_Y2			, TEACH_PARAM::JIG_SHUTTLE_Y2_to_LOAD		, 0., 0., ACC_300ms, ACC_300ms);
	m_Param[TEACH_PARAM::JIG_SHUTTLE_Y2_to_INSP			] = TEACH_PARAM(_T("JIG_SHUTTLE_Y2_to_INSP"			), AXIS_JIG_SHUTTLE_Y2			, TEACH_PARAM::JIG_SHUTTLE_Y2_to_INSP		, 0., 0., ACC_300ms, ACC_300ms);
	m_Param[TEACH_PARAM::JIG_SHUTTLE_Y2_to_MANUAL		] = TEACH_PARAM(_T("JIG_SHUTTLE_Y2_to_MANUAL"		), AXIS_JIG_SHUTTLE_Y2			, TEACH_PARAM::JIG_SHUTTLE_Y2_to_MANUAL		, 0., 0., ACC_300ms, ACC_300ms);
	...
	m_Param[TEACH_PARAM::ACTIVE_ALIGN_X1_to_LEFT		] = TEACH_PARAM(_T("ACTIVE_ALIGN_X1_to_LEFT"		), AXIS_ACTIVE_ALIGN_X1			, TEACH_PARAM::ACTIVE_ALIGN_X1_to_LEFT		, 0., 0., ACC_300ms, ACC_300ms);
	m_Param[TEACH_PARAM::ACTIVE_ALIGN_X1_to_RIGHT		] = TEACH_PARAM(_T("ACTIVE_ALIGN_X1_to_RIGHT"		), AXIS_ACTIVE_ALIGN_X1			, TEACH_PARAM::ACTIVE_ALIGN_X1_to_RIGHT		, 0., 0., ACC_300ms, ACC_300ms);

	m_Param[TEACH_PARAM::ACTIVE_ALIGN_X2_to_LEFT		] = TEACH_PARAM(_T("ACTIVE_ALIGN_X2_to_LEFT"		), AXIS_ACTIVE_ALIGN_X2			, TEACH_PARAM::ACTIVE_ALIGN_X2_to_LEFT		, 0., 0., ACC_300ms, ACC_300ms);
	m_Param[TEACH_PARAM::ACTIVE_ALIGN_X2_to_RIGHT		] = TEACH_PARAM(_T("ACTIVE_ALIGN_X2_to_RIGHT"		), AXIS_ACTIVE_ALIGN_X2			, TEACH_PARAM::ACTIVE_ALIGN_X2_to_RIGHT		, 0., 0., ACC_300ms, ACC_300ms);
