// CGxButtonEx.h  : Microsoft Visual C++로 만든 ActiveX 컨트롤 래퍼 클래스의 선언입니다.
...
public:
	...
	void SetEnable(BOOL bFlag)
	{
		...
		InvokeHelper(0x68, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bFlag);
	}
	...
	{
		static BYTE parms[] = VTS_I2 ;
		InvokeHelper(0x6d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, nIdx);
	}
	CString GetMultiCaption(short nIdx)
	{
		CString result;
		static BYTE parms[] = VTS_I2 ;
		InvokeHelper(0x73, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, nIdx);
		return result;
	}
	void SetMultiCaption(short nIdx, LPCTSTR sMsg)
	{
		static BYTE parms[] = VTS_I2 VTS_BSTR ;
		InvokeHelper(0x74, DISPATCH_METHOD, VT_EMPTY, NULL, parms, nIdx, sMsg);
	}
	BOOL GetFlashMode()
	{
		BOOL result;
	...
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0x76, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bFlag);
	}
	...
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0x78, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bFlag);
	}
	void GxBroadcastChangeCaptionIndex(long hHandle, short nIdx)
	{
		static BYTE parms[] = VTS_I4 VTS_I2 ;
		InvokeHelper(0x7a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, hHandle, nIdx);
	}
