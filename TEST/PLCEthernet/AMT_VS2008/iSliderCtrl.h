...
/////////////////////////////////////////////////////////////////////////////
// CIsliderControl 래퍼 클래스입니다.

class CIsliderControl : public CWnd
{
protected:
	DECLARE_DYNCREATE(CIsliderControl)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0xC5412E06, 0x2E2F, 0x11D3, { 0x85, 0xBF, 0x0, 0x10, 0x5A, 0xC8, 0xB7, 0x15 } };
		return clsid;
	}
...
//
	...
	{
		unsigned long result;
		InvokeHelper(0x45, DISPATCH_PROPERTYGET, VT_UI4, (void*)&result, NULL);
		return result;
	}
	...
	{
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0x2a, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	...
	long get_MouseControlStyle()
	{
		long result;
		InvokeHelper(0x36, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_MouseControlStyle(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
	...
	void SaveImageToBitmap(LPCTSTR FileName)
	{
		...
		InvokeHelper(0x3b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FileName);
	}
	void SaveImageToMetaFile(LPCTSTR FileName)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x3c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FileName);
	}
	void SaveImageToJPEG(LPCTSTR FileName, long Compression, BOOL Progressive)
	{
		static BYTE parms[] = VTS_BSTR VTS_I4 VTS_BOOL ;
		InvokeHelper(0x3d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FileName, Compression, Progressive);
	}
	long OPCAddItem()
	{
		long result;
