...
public:
	...
	static BOOL FindPath( HWND hOwner , CString& path,  LPCTSTR szStartDir = NULL, LPCTSTR caption = "Select Folder") ;
	static CString FindFilePath ( BOOL isOpen , LPCTSTR defaultFilePath , LPCTSTR filter = "All Files(*.*)|*.*||");
